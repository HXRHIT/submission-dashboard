...
python scripts/export_calendar.py          # ICS 캘린더 내보내기
...
dashboard/   app.py (8개 뷰: 캘린더·비교표·Fit·URL검증·비용·지표·Watchlist·AI 제안 검토)
scripts/     validate_data.py, export_calendar.py, apply_updates.py
data/proposed_updates/   AI 수정 초안 (검토 후 apply_updates.py로 병합)
